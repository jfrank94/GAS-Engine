                ...
                if (one != two) { //An object can't collide with itself
                    ...
                    /**if ( ((((one.box.minx) <= (two.box.maxx)) && ((one.box.maxx) >= (two.box.minx)))
                            ...
                            while (check == false && c < (CurrentCollisions.size() - 1)) {
                                for (c = 0; c < CurrentCollisions.size(); c++) {
                                    ...
                                    if (CurrentCollisions.get(c).rbodpairequals(testarrayforward) == true) {
                                        // System.out.println("A collision between " + one.name + " and " + two.name + " was already in the list.");
                                        check = true;
                        ...
                        if (check == false) { //if it didn't find a match
                            ...
                            //System.out.println("Added a collision between " + one.name + " and " + two.name);
                        }
                    }
                    //else {System.out.println("There was no collision between " + one.name + " and " + two.name);}
                } //else {
                // System.out.println("The object was attempting to collide with itself"); }
            }
            ...
            //Okay, we now have two awake objects that have collided. Now what?
              ...
              //          CurrentCollisions.remove(a);
               ...
               //     }
                ...
                //System.out.println(one.name + " had a velocity of x=" + one.velocityx + ", y=" + one.velocityy + ", z= " + one.velocityz);
                //System.out.println(two.name + " had a velocity of x=" + two.velocityx + ", y=" + two.velocityy + ", z= " + two.velocityz);

                //System.out.println("The collision type was " + collistype);
                ...
                //System.out.println(one.name + " now has a velocity of x=" + one.velocityx + ", y=" + one.velocityy + ", z= " + one.velocityz);
                //System.out.println(two.name + " now has a velocity of x=" + two.velocityx + ", y=" + two.velocityy + ", z= " + two.velocityz);
            }
